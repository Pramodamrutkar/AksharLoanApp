    ...
    <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-shadow gradient-45deg-green-teal">
      <div class="nav-wrapper">
        ...
        <ul class="dropdown-content" id="profile-dropdown">
          <li><a class="grey-text text-darken-1" href="<?php echo base_url();?>school/service/profile"><i class="material-icons">person_outline</i> Profile</a></li>
          <li><a class="grey-text text-darken-1" href="<?php echo base_url();?>school/service/settings"><i class="material-icons">settings</i> Settings</a></li>
          <li class="divider"></li>
          <li><a class="grey-text text-darken-1" href="<?php echo base_url();?>school/service/logout"><i class="material-icons">keyboard_tab</i> Logout</a></li>
        </ul>
      </div>
    </nav>
  </div>
...
<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light navbar-full sidenav-active-rounded">
  <div class="brand-sidebar" style="background-color:#3CAF5E;">
    <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="<?php echo base_url();?>school/service"><img src="<?php echo assets_url();?>images/topleftadmin.png" alt="materialize logo" style="height: 35px;margin-top: -5px;" /><span class="logo-text hide-on-med-and-down"></span></a> 
      <!--<a class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a>--></h1>
  </div>
  <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
    <li class="bold"><a class="waves-effect waves-cyan " href="<?php echo base_url();?>school/service"><i class="material-icons">dashboard</i><span class="menu-title" data-i18n="Documentation">Dashboard</span></a> </li>
    <li class="bold"><a class="waves-effect waves-cyan " href="<?php echo base_url();?>school/service/uploadData"><i class="material-icons">upload</i><span class="menu-title" data-i18n="Documentation">Upload Student</span></a> </li>
    <!-- <li class="bold"><a class="waves-effect waves-cyan " href="<?php echo base_url();?>school/service/loandata"><i class="material-icons">description</i><span class="menu-title" data-i18n="Documentation">Student Loan</span></a> </li> -->
    <li class="bold"><a class="waves-effect waves-cyan " href="<?php echo base_url();?>school/service/student"><i class="material-icons">face</i><span class="menu-title" data-i18n="Documentation">Student Info</span></a> </li>
    <!---<li class="bold"><a class="waves-effect waves-cyan " href="//echo base_url(); school/service/designation"><i class="material-icons">group_add</i><span class="menu-title" data-i18n="Documentation">Designation</span></a> </li> -->
    <!-- <li class="bold"><a class="waves-effect waves-cyan " href="#"><i class="material-icons">credit_score</i><span class="menu-title" data-i18n="Documentation">Loans Info</span></a> </li>    
    <li class="bold"><a class="waves-effect waves-cyan " href="#"><i class="material-icons">group_add</i><span class="menu-title" data-i18n="Documentation">Payment Details</span></a> </li> -->
    <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i class="material-icons">receipt</i><span class="menu-title" data-i18n="Invoice">Student Reports</span></a>
    ...
    <li class="bold"><a class="waves-effect waves-cyan " href="<?php echo base_url();?>school/service/staff"><i class="material-icons">group_add</i><span class="menu-title" data-i18n="Documentation">School Staff</span></a> </li>
    <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i class="material-icons">receipt</i><span class="menu-title" data-i18n="Invoice">Staff Reports</span></a>
      <div class="collapsible-body">
        <ul class="collapsible collapsible-sub" data-collapsible="accordion">
          <li><a href="<?php echo base_url();?>school/service/staffReport"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Invoice Edit">Staff Report</span></a> </li>
          <li><a href="<?php echo base_url();?>school/service/staffloanreport"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Invoice Edit">Staff Loan Report</span></a> </li>
          </ul>
      </div>
    </li>      
    <?php 
...
<?php
if(empty($this->session->userdata('schoolData')["schoolID"])){
