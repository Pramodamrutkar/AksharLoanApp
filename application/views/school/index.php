                ...
                <div class="card gradient-45deg-red-pink gradient-shadow min-height-100 white-text animate fadeLeft">
                  <div class="padding-4">
                    <div class="row">
                      ...
                      <div class="col s5 m5 right-align">
                        <h5 class="mb-0 white-text"><?php echo $noOfstudent; ?></h5>
                        <p class="no-margin"></p>
                        <p></p>
                      </div>
                    </div>
             ...
             <!--  <div class="col s12 m6 l6 xl3">
                <div class="card gradient-45deg-red-pink gradient-shadow min-height-100 white-text animate fadeLeft">
                  <div class="padding-4">
                    <div class="row">
                      <div class="col s7 m7"> <i class="material-icons background-round mt-5">perm_identity</i>
                        <p>No of student who downloaded App</p>
                      </div>
                      <div class="col s5 m5 right-align">
                        <h5 class="mb-0 white-text"><?php echo $noOfstudent; ?></h5>
                        <p class="no-margin"></p>
              ...
              <div class="col s12 m6 l6 xl3">
                <div class="card gradient-45deg-red-pink gradient-shadow min-height-100 white-text animate fadeLeft">
                  <div class="padding-4">
                    <div class="row">
                      <div class="col s7 m7"> <i class="material-icons background-round mt-5">perm_identity</i>
                        <p>No of Remittances through App</p>
                      </div>
                      <div class="col s5 m5 right-align">
                        <h5 class="mb-0 white-text"><?php echo $noOfstudent; ?></h5>
                        <p class="no-margin"></p>
              ...
              <div class="col s12 m6 l6 xl3">
                <div class="card gradient-45deg-red-pink gradient-shadow min-height-100 white-text animate fadeLeft">
                  <div class="padding-4">
                    <div class="row">
                      <div class="col s7 m7"> <i class="material-icons background-round mt-5">perm_identity</i>
                        <p>Amount Remitted through App</p>
                      </div>
                      <div class="col s5 m5 right-align">
                        <h5 class="mb-0 white-text"><?php echo $noOfstudent; ?></h5>
                        <p class="no-margin"></p>
              ...
              <div class="col s12 m6 l6 xl3">
                <div class="card gradient-45deg-red-pink gradient-shadow min-height-100 white-text animate fadeLeft">
                  <div class="padding-4">
                    <div class="row">
                      <div class="col s7 m7"> <i class="material-icons background-round mt-5">perm_identity</i>
                        <p>No of Fee Loan Taken Till Date</p>
                      </div>
                      <div class="col s5 m5 right-align">
                        <h5 class="mb-0 white-text"><?php echo $noOfstudent; ?></h5>
                        <p class="no-margin"></p>
