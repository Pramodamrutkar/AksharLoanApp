...
<link rel="stylesheet" type="text/css" href="<?php echo assets_url();?>data-tables/css/jquery.dataTables.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo assets_url();?>data-tables/extensions/responsive/css/responsive.dataTables.min.css">

<link rel="stylesheet" type="text/css" href="<?php echo assets_url();?>css/custom.css">
<link rel="stylesheet" type="text/css" href="<?php echo assets_url();?>sweetalert/sweetalert.css">
...
<link rel="stylesheet" type="text/css" href="<?php echo assets_url();?>css/page-users.css">
<script type="text/javascript">
	var pageTitle = '<?php echo $pageTitle;?>';
	var baseUrl = '<?php echo base_url();?>';
	var serviceUrl = '<?php echo base_url('school/service/');?>';
</script>
