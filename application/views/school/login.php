...
function processLogin(frm){
	$(frm).ajaxSubmit({url: '<?php echo base_url('school/login/postIndex');?>',beforeSubmit: function (formData, jqForm, options){
		var queryString = $.param(formData);
	},clearForm: false,resetForm: false,success: function (responseText, statusText, xhr, $form){
		result = JSON.parse(responseText);
		if (result["Status"] == "true"){
			window.location ="<?php echo base_url('school/service');?>";
		}else{
